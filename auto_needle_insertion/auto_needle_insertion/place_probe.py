...
class ForceZMonitor:
    ...
    def __init__(
        ...
        self._node = rclpy.create_node("place_probe_force_z_monitor")
...
def main() -> None:
    ...
    try:
        ...
        if stopped_by_force:
            logger.info("place_probe approach stopped at force threshold")
        else:
            logger.info("place_probe approach completed successfully")
